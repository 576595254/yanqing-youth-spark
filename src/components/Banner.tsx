...
const Banner = () => {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      <div className="absolute inset-0 bg-banner-pattern bg-cover bg-center bg-no-repeat">
        <div className="absolute inset-0 bg-banner-gradient"></div>
      </div>
      ...
      <div className="container mx-auto px-4 h-full flex flex-col items-center justify-center relative z-10">
        <div className={`text-center max-w-3xl transition-all duration-1000 ${loaded ? 'opacity-100' : 'opacity-0 transform translate-y-10'}`}>
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            ...
            <span className="text-activeOrange text-shadow-lg">选调生团队成果展示</span>
          </h1>
          ...
          <button
            ...
            className="group bg-activeOrange hover:bg-amber-500 text-white px-8 py-4 rounded-full text-lg font-bold transition-all duration-300 shadow-lg hover:shadow-xl flex items-center space-x-3 mx-auto"
          >
            <span>探索项目化管理亮点</span>
