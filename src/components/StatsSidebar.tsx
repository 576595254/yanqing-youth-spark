...
const StatItem: React.FC<StatItemProps> = ({ title, value, suffix, isVisible, icon }) => {
  ...
  return (
    <div className="stats-item group hover:bg-gradient-to-br hover:from-yanqingGreen/5 hover:to-activeOrange/5">
...
const StatsSidebar = () => {
  ...
  return (
    <div ref={ref} className="fixed top-1/3 right-4 z-40 hidden lg:block transition-all duration-500">
      <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-lg p-3 border border-gray-100">
        <div className="bg-yanqingGreen text-white text-center py-2 px-3 rounded-t-lg -mt-6 mx-auto w-fit">
          <h3 className="text-xs font-bold">项目成果</h3>
        </div>
        
        <div className="space-y-3 w-32 mt-2">
